...
window_x=int((window_width/2) - (screen_width/2))
window_y=int((window_height/2) - (screen_height/2))
...
def draw():
    ...
    if(game_over):
        canvas.create_text(WINDOW_WIDTH/2,WINDOW_HEIGHT/2,font="Arial,20",text=f"Game Over: {score} Points",fill="white")
    else:
